...
import heroImage from '../assets/hero-gift-box.webp'
...
export default function App() {
    const links: {
        ...
        },
        {
            ...
            url: 'https://cuppino.eu/products/italian-extra-virgin-olive-oil',
        },
        {
            icon: '🎁',
            text: 'Gift Boxes',
            url: 'https://cuppino.it/collections/cuppino-gift-boxes',
        },
        {
            icon: '📖',
            text: 'Our Story',
            url: 'https://cuppino.it/pages/story',
        },
        {
            icon: '⭐',
            text: 'Customer Reviews',
            url: 'https://www.trustpilot.com/review/cuppino.it?languages=all',
        },
    ]
            ...
            <div className='w-full max-w-[580px] mx-auto px-4 md:px-0'>
                ...
                >
                    ...
                    <p className='text-base'>
                        ...
                        sun-ripened antipasti. <br></br>No middlemen. Only
                        genuine food.
                    </p>
                </section>
                    ...
                    <div className='flex flex-col gap-[14px]'>
                        {links.map((link, index) => (
                            <a
                                key={index}
                                href={link.url}
                                className='group relative flex items-center justify-center gap-3 px-[18px] py-[14px] bg-[#FFF0D7] rounded-[100px] border-[2px] border-[#194C24] transition-all duration-150 hover:-translate-y-0.5 hover:bg-[#E9E9BD]'
                                style={{
                            ...
                            >
                                ...
                                {link.badge && (
                                    <span
                                        className='absolute -top-2.5 right-4 px-2 py-0.5 rounded-[100px] border-[2px] border-[#194C24] bg-[#D94F30] text-[10px] md:text-[11px] leading-none uppercase tracking-[0.08em]'
                                        style={{
                                            fontWeight: '700',
                                            color: '#FFF0D7',
                                            paddingTop: '3px',
            ...
            <footer className='bg-[#871E1E] text-[#F5F1E8] py-6 mt-8'>
                <div className='text-center space-y-3'>
                    ...
                    <div className='flex justify-center gap-4 text-xs'>
                        <a
                            href='https://cuppino.it/policies/privacy-policy'
                        ...
                        <span>|</span>
                        <a
                            href='https://cuppino.it/pages/shipping-returns'
                            className='hover:underline'
                        >
                            Shipping & Returns
                        </a>
                        <span>|</span>
                        <a
                            href='https://cuppino.it/pages/contact'
                            className='hover:underline'
                        >
                            Contact
                        </a>
